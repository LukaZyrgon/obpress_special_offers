...
add_action( 'init', 'obpress_specialoffers_load_textdomain' );
 
function obpress_specialoffers_load_textdomain() {
    load_plugin_textdomain( 'OBPress_SpecialOffers', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' ); 
}
